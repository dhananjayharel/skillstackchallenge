...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'challenge/add', loadChildren: './test/operations/add/add.module#AddOnlineTestPageModule' },
            { path: 'challenge/edit/:id', loadChildren: './test/operations/add/add.module#AddOnlineTestPageModule' },			
